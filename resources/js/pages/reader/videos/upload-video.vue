        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group col-md-12 mt-3 mx-auto">
              ...
              <vue-editor v-model="videoForm.description" :class="{ 'is-invalid': videoForm.errors.has('description') }" />
          ...
          <div class="col-md-6">
            <div class="form-group col-md-8 mx-auto mx-auto" hidden>
              <input ref="file" type="file" name="file" accept="video/*" @change="previewFile">
