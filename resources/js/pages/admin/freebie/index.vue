  ...
  <b-container class="pt-5">
    <b-row>
      <b-card class="w-100">
        ...
        <b-card-body>
          <b-row class="py-3">
            <b-col>
              <b-button variant="secondary" @click="showCreateModal()">
                CREATE
              </b-button>
            </b-col>
          </b-row>
          <b-table hover :items="items" :fields="fields" responsive>
            <template #cell(id)="data">
              <b-dropdown variant="link" no-caret>
                ...
                <b-dropdown-item @click="showUpdateModal(data.value)">
                  <b-icon-pencil-square /> Update
                </b-dropdown-item>
                <b-dropdown-item @click="showDeleteModal(data.value)">
                  <b-icon-trash2 /> Delete
                </b-dropdown-item>
              </b-dropdown>
            </template>

            <template #cell(photo)="data">
              <b-img :src="`/images/freebies/${data.value}`" width="300" height="auto" fluid />
            </template>

            <template #cell(is_active)="data">
              <b-form-checkbox v-model="data.value" switch @input="handleActiveStatus(data)" />
            </template>
          </b-table>
        </b-card-body>
      </b-card>
    ...
    <b-modal id="create-modal">
      ...
      <div class="d-block text-center">
        <b-row class="my-1">
          <b-col>
            <b-img :src="`/images/profile.jpg`" height="auto" width="150px" fluid />
          </b-col>
        </b-row>
    ...
    <b-modal id="update-modal">
      ...
      <div class="d-block text-center">
        <b-row class="my-1">
          <b-col>
            <b-img :src="`/images/freebies/${updateModalData.photo}`" height="auto" width="150px" fluid />
          </b-col>
        </b-row>

        <b-row class="my-1">
          <b-col sm="6" class="py-3 mx-auto">
            <b-form-file v-model="filePhoto" accept="image/*" plain @input="handleImageOnUpdate(updateModalData.id)" />
          </b-col>
        </b-row>
        ...
        <b-row class="my-1">
          ...
          <b-col sm="10">
            <b-form-input id="input-small" v-model="updateModalData.freebie_name" size="sm" />
          </b-col>
        </b-row>
        ...
        <b-row class="my-1">
          ...
          <b-col sm="10">
            <b-form-textarea id="textarea-small" v-model="updateModalData.description" size="sm" />
          </b-col>
        </b-row>
        ...
        <b-row class="my-1">
          ...
          <b-col sm="10">
            <b-form-input id="input-small" v-model="updateModalData.points" size="sm" />
          </b-col>
        </b-row>
      </div>
      <template #modal-footer>
