  ...
  <card class="py-3 m-4">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group col-md-10 mx-auto mx-auto  " hidden>
            <input ref="file" :class="{ 'is-invalid': additionalForm.errors.has('profile_photo') }" class="form-control" type="file" name="profile_photo" accept="image/x-png,image/gif,image/jpeg" @change="previewFile">
            <has-error :form="additionalForm" field="profile_photo" />
          </div>
        </div>

        <!-- Submit Button -->
        <div v-if="isProfileUpdating" class="form-group row col-md-4 mx-auto mt-3">
        ...
        <div v-else class="form-group row  col-md-4 mx-auto mt-3">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group col-md-10 mx-auto">
            <label>Gender</label>
            <select id="gender" v-model="readerForm.gender" class="form-control" required :disabled="!isUpdating">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group col-md-11 mx-auto">
            ...
            <textarea v-model="additionalForm.reader_bio" :class="{ 'is-invalid': additionalForm.errors.has('reader_bio') }" class="form-control" type="text" name="reader_bio" :readonly="!isAdditionalUpdating" />
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group col-md-10 mx-auto">
            ...
            <birth-datepicker v-model="additionalForm.birthdate" :class="{ 'is-invalid': additionalForm.errors.has('birthdate') }" class="form-control" name="birthdate" value-is-string="true" :disabled="!isAdditionalUpdating" />
        ...
        <!-- Submit Button -->
        <div v-if="isAdditionalUpdating" class="form-group row  col-md-4 mx-auto mt-3">
          <div class="col-md-6 px-0 pr-lg-1">
            <!-- Bac Button -->
    ...
    <form @submit.prevent="updatePassword" @keydown="additionalForm.onKeydown($event)">
      <div class="row">
        ...
        <!-- Submit Button -->
        <div v-if="isPasswordUpdating" class="form-group row  col-md-4 mx-auto mt-3">
          <div class="col-md-6 px-0 pr-lg-1">
            <!-- Bac Button -->
