<template>
  <section class="py-5">
    <div class="container text-center">
      ...
      <ul class="list-inline small text-uppercase mb-0">
        <li class="list-inline-item align-middle">
          <img class="rounded-circle shadow-sm" src="img/person-1.jpg" alt="" width="40">
        </li>
        <li class="list-inline-item mr-0 text-muted align-middle">
          By
        </li>
        <li class="list-inline-item align-middle mr-0">
          <a class="font-weight-bold reset-anchor text-danger" href="#">{{ vlog.user.firstName + ' ' + vlog.user.lastName }}</a>
        </li>
        <li class="list-inline-item text-muted align-middle mr-0">
          |
        </li>
        <li class="list-inline-item text-muted align-middle mr-0">
          {{ dateFormat( vlog.created_at, 'LL' ) }}
        </li>
        <li class="list-inline-item text-muted align-middle mr-0">
          |
        </li>
    ...
    <div class="player-container  py-5">
      <vue-core-video-player :autoplay="false" class="w-100" :src="'/uploads/vlog/' + vlog.file_name" />
    </div>
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mb-5 mb-lg-0">
          ...
          <div class="vlog-content text-break pb-5" v-html="vlog.description" />
          <ul id="pills-tab" class="nav nav-pills mb-3 review-suggestions" role="tablist">
            <li class="nav-item" role="presentation">
              <a id="pills-review-tab" class="nav-link active" data-toggle="pill" href="#pills-review" role="tab" aria-controls="pills-review" aria-selected="true">Review</a>
            </li>
            <li class="nav-item" role="presentation">
              <a id="pills-suggestions-tab" class="nav-link" data-toggle="pill" href="#pills-suggestions" role="tab" aria-controls="pills-suggestions" aria-selected="false">Suggestions</a>
            </li>
          </ul>
          <div id="pills-tabContent" class="tab-content">
            <div id="pills-review" class="tab-pane fade show active" role="tabpanel" aria-labelledby="pills-review-tab">
              ...
              <form class="mb-5" @submit.prevent="reviewFormSubmit">
                <div class="row">
                  <div class="form-group col-lg-12">
                    <star-rating v-model="reviewForm.stars" :star-size="20" :show-rating="false" />
                    <has-error :form="reviewForm" field="stars" />
                  </div>
                  <template v-if="!authenticated">
                    <div class="form-group col-lg-6">
                      <input v-model="reviewForm.name" class="form-control" :class="{ 'is-invalid': reviewForm.errors.has('name') }" type="text" name="name" placeholder="Full Name e.g. Jason Doe">
                      <has-error :form="reviewForm" field="name" />
                    </div>
                    <div class="form-group col-lg-6">
                      <input v-model="reviewForm.email" class="form-control" :class="{ 'is-invalid': reviewForm.errors.has('email') }" type="email" name="email" placeholder="Email Address e.g. Jason@email.com">
                      <has-error :form="reviewForm" field="email" />
                    </div>
                  </template>
                  <div class="form-group col-lg-12">
                    <textarea v-model="reviewForm.message" class="form-control" :class="{ 'is-invalid': reviewForm.errors.has('message') }" name="message" rows="5" placeholder="Leave your review" />
                  ...
                  <li v-for="( review, review_index ) in reviews" :key="'reviews-' + review_index">
                    <div class="d-flex mb-4">
                      <div class="pr-2 flex-grow-1" style="width: 75px; min-width: 75px;">
                        <img class="rounded-circle shadow-sm img-fluid img-thumbnail" :src="userImageeUrl + review.avatar" alt="">
                      </div>
                      <div class="pl-2">
                        <p class="small mb-0 text-danger">
                          {{ dateFormat( review.created_at ) }}
                        </p>
                        <h5>{{ review.name }} <star-rating :star-size="20" :show-rating="false" :read-only="true" :rating="review.stars" /></h5>
                        <p class="text-muted text-small mb-2 text-break">
                          {{ review.message }}
                        </p>
                      </div>
                    </div>
            ...
            <div id="pills-suggestions" class="tab-pane fade" role="tabpanel" aria-labelledby="pills-suggestions-tab">
              <h3 class="h4 mb-4 text-danger">
                Leave a suggestion
              </h3>
              <form class="mb-5" @submit.prevent="suggestionFormSubmit">
                <div class="row">
                  <div class="form-group col-lg-12">
                    <textarea v-model="suggestionForm.message" class="form-control" :class="{ 'is-invalid': suggestionForm.errors.has('message') }" name="message" rows="5" placeholder="Leave your review" />
        ...
        <div class="col-lg-4">
          ...
          <div class="mb-5 text-center">
            <img class="mb-3 rounded-circle img-thumbnail shadow-sm" :src="userImageeUrl + 'testimonials-4.jpg'" alt="" width="110">
            <h3 class="h4">
              Reader
            </h3>
            <p class="text-small text-muted px-sm-4">
          ...
          <div class="px-4 py-5 section-bg mb-5 text-center">
            ...
            <form @submit.prevent="subscribeFormSubmit">
              ...
              <v-button class="btn btn-danger btn-lg" :disabled="!subscribeForm.email">
                Subscribe Now!
              </v-button>
            </form>
          </div>
          <div class="pb-5">
            <div class="container pb-4">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-1.jpg'" alt="">
                    <div class="instagram-item-overlay" /></a>
                </div>
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-2.jpg'" alt="">
                    <div class="instagram-item-overlay" /></a>
                </div>
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-3.jpg'" alt="">
                    <div class="instagram-item-overlay" /></a>
                </div>
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-4.jpg'" alt="">
                    <div class="instagram-item-overlay" /></a>
                </div>
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-6.jpg'" alt="">
                    <div class="instagram-item-overlay" /></a>
                </div>
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-5.jpg'" alt="">
                    <div class="instagram-item-overlay" /></a>
                </div>
                <div class="col-lg-4 col-md-6 px-md-1 py-1">
                  <a class="instagram-item d-block w-100 reset-anchor text-white" href="#"><img class="img-fluid" :src="imageUrl + 'listing-tnumbnail-1.jpg'" alt="">
